...
<div class="container content-wrapper">
    <div class="row" style="margin-left: 0px; margin-right: 55px;">
        <div class="col-md-12">
            <?php
            echo form_open_multipart('admin/activity/edit/'.$slug.'/'.$activity['id'], array('class' => 'form-horizontal'));
            ?>
            ...
            <div class="form-group">
                ...
                <select name="cat" class="form-control cat">
                    <?php if ($activity['category'] == 1): ?>
                        <option value="1">Thông báo</option>
                    <?php elseif($activity['category'] == 2): ?>
                        <option value="2">Tuyển sinh</option>
                    <?php elseif($activity['category'] == 3): ?>
