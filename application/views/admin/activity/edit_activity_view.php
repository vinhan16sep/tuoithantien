...
<div class="container content-wrapper">
    <div class="row" style="margin-left: 0px; margin-right: 55px;">
        <div class="col-md-12">
            <?php
            echo form_open_multipart('admin/activity/edit', array('class' => 'form-horizontal'));
            ?>
            <div class="form-group">
                <?php
                echo form_label('Tiêu đề', 'title');
                echo form_error('title');
                echo form_input('title', set_value('title', $activity['title']), 'class="form-control" id="title"');
                ?>
            </div>
            <div class="form-group">
                <?php
            ...
            <div class="form-group picture sub-cat">
                ...
                echo form_dropdown('category', $categories, set_value('category', $activity['category_id']), 'class="form-control" id="category"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                ?>
                <img src="<?php echo base_url('assets/upload/activity/'.$activity["image"]) ?>" alt="" width=80px>
            </div>
            <div class="form-group">
                <?php
            ...
            <div class="form-group">
                ...
                echo form_textarea('content', set_value('content', $activity['content'], false), 'class="form-control content"')
                ?>
            </div>
            <br>
            <div class="form-group col-sm-12 text-right">
                <input type="hidden" name="id" value="<?php echo $activity['id'] ?>">
                <input type="hidden" name="url" value="<?php echo $activity['category_id'] ?>">
                <?php
