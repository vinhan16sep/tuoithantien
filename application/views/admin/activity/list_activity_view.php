                                ...
                                <tr class="row_<?php echo $value['id'] ?>">
                                    ...
                                    <td>
                                        <form class="form_ajax">
                                            <a href="<?php echo base_url('admin/comment/activity/'.$value['slug']); ?>" title="Danh sách comment" class="show_comment" data-category="activity" data-slug="<?php echo $value['slug'] ?>">
