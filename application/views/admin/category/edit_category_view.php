            ...
            <div class="modified-mode">
                <div class="col-lg-10 col-lg-offset-0" style="margin-left: 15px;">
                    ...
                    <div class="form-group picture">
                        ...
                        echo form_input('title', set_value('title', $category['title']), 'class="form-control" id="title"');
                        ?>
                    </div>
                    <div class="form-group picture">
                        <?php
                        ...
                        echo form_input('slug', set_value('slug', $category['slug']), 'class="form-control" readonly id="slug" readonly');
                        ?>
                    </div>
