        ...
        <div class="container" style="width: 95%;">
            ...
            <div class="row">
                <div class="col-md-12" style="margin-top: 10px;">
                        <?php
                            echo form_open_multipart('admin/introduce/overview', array('class' => 'form-horizontal'));
                        ?>
                        <table class="table table-hover table-bordered table-condensed">
                            <tr>
                                <td><b><a href="#">Ảnh đại diện</a></b></td>
                                <td><img src="<?php echo base_url('assets/upload/introduce/'.$introduces['image']) ?>" alt="" style="width: 50%"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="title" value="<?php echo $introduces['title'] ?>" class="form-control" readonly id="title"></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="slug" value="<?php echo $introduces['slug'] ?>" class="form-control" readonly id="slug">
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="form-group">
                                    <textarea name="content" class="form-control content txt_hide" style="height: 200px"><?php echo $introduces['content'] ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
