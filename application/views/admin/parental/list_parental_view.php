...
<div class="content-wrapper" style="min-height: 916px;">
    <section class="content row">
        <?php if(isset($category_id)): ?>
            <a type="button" href="<?php echo site_url('admin/parental/create/'.$category_id); ?>" class="btn btn-primary">THÊM MỚI</a>
        <?php else: ?>
            <a type="button" href="<?php echo site_url('admin/parental/create'); ?>" class="btn btn-primary">THÊM MỚI</a>
        <?php endif; ?>

        <a type="button" href="<?php echo site_url('admin/parental/category'); ?>" class="btn btn-normal">DANH MỤC</a>
        <div class="container col-md-12">
            <div>
                <span><?php echo $this->session->flashdata('message'); ?></span>
            </div>
            <!--            <div class="row">-->
            <!--                <form action="--><?php //echo base_url('admin/parental/index/'.$slug) ?><!--" class="form-horizontal" method="get">-->
            <!--                    <a type="button" href="--><?php //echo site_url('admin/parental/create/'.$slug); ?><!--" class="btn btn-primary">THÊM MỚI</a>-->
                                ...
                                <tr class="row_<?php echo $value['id'] ?>">
                                    ...
                                    <td>
                                        <form class="form_ajax">
                                            <a href="<?php echo base_url('admin/comment/parental/'.$value['slug']); ?>" title="Danh sách comment">
