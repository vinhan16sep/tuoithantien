                    ...
                    <ul class="list-unstyled list-group">
                        <?php if ($sidebar != ''): ?>
                            <?php foreach ($sidebar as $key => $value): ?>
                                <li class="list-group-item"><a href="<?php echo base_url('hoat-dong/'.$category['slug'].'/'.$value['slug']) ?>" <?php echo ($value['slug'] == $this->uri->segment(3))? 'style="color: blue"' : '' ?> ><?php echo $value['title'] ?></a></li>
                            <?php endforeach ?>
                        <?php else: ?>
