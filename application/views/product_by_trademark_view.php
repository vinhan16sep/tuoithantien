        ...
        <div class="post-content col-lg-9 col-md-9 col-sm-9 col-xs-12">
            <div class="post-cover">
                <?php if(empty($trademark['image'])): ?>
                    <img class="w-100" src="<?php echo site_url('assets/public/img/trademark_cover.jpg'); ?>" alt="trademark">
                <?php else: ?>
                    <img class="w-100" src="<?php echo site_url('assets/upload/trademark/' . $trademark['image']); ?>" alt="trademark">
                <?php endif; ?>
            </div>
