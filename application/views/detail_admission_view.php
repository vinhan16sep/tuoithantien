                ...
                <ul class="list-unstyled">
                    <?php if ($sidebar != ''): ?>
                        <?php foreach ($sidebar as $key => $value): ?>
                            <li><a href="<?php echo base_url('thong-tin-nhap-hoc/'.$category['slug'].'/'.$value['slug']) ?>" <?php echo ($value['slug'] == $this->uri->segment(3))? 'style="color: blue"' : '' ?> ><?php echo $value['title'] ?></a></li>
                        <?php endforeach ?>
                    <?php else: ?>
