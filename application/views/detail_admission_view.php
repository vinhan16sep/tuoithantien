        ...
        <div class="row">
                    ...
                    <ul class="list-unstyled list-group">
                        <?php if ($sidebar != ''): ?>
                            <?php foreach ($sidebar as $key => $value): ?>
                                <li class="list-group-item"><a href="<?php echo base_url('thong-tin-nhap-hoc/'.$category['slug'].'/'.$value['slug']) ?>" <?php echo ($value['slug'] == $this->uri->segment(3))? 'style="color: #008b44"' : '' ?> ><?php echo $value['title'] ?></a></li>
                            <?php endforeach ?>
                        <?php else: ?>
            ...
            <div class="blogs col-md-9 col-sm-9 col-xs-12">
                <div class="blogs_cover">
                    <img src="<?php echo base_url('assets/upload/admission/'.$detail['image']) ?>" alt="ảnh cover bài viết" width=100%>
                </div>
                ...
                <div class="comments">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                            <input type="hidden" name="category" value="admission" id="category">
