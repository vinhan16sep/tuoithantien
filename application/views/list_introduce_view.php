                    ...
                    <ul class="list-unstyled list-group">
                        <?php if ($sidebar): ?>
                            <?php foreach ($sidebar as $value): ?>
                                <li class="list-group-item"><a href="<?php echo base_url('gioi-thieu/'.$value['slug']) ?>" <?php echo ($value['slug'] == $this->uri->segment(2)? 'style="color: #008b44"' : '') ?> ><?php echo $value['title'] ?></a></li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </ul>
                </div>
                    ...
                    <?php if ($list != ''): ?>
                        <?php foreach ($list as $key => $value): ?>
                            <div class="item col-md-4 col-sm-6 col-xs-12">
                                <div class="inner">
                                    <div class="mask">
                                        <img src="<?php echo site_url('assets/upload/introduce/'.$value['image']) ?>">
                                    </div>
