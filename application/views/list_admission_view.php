                    ...
                    <ul class="list-unstyled list-group">
                        <?php if ($sidebar): ?>
                            <?php foreach ($sidebar as $value): ?>
                                <li class="list-group-item"><a href="<?php echo base_url('thong-tin-nhap-hoc/'.$value['slug']) ?>" <?php echo ($value['slug'] == $this->uri->segment(2)? 'style="color: #008b44"' : '') ?> ><?php echo $value['title'] ?></a></li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </ul>
                </div>
